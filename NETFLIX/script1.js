...
const api="api_key=0d7ffcb538472b4a248392fdaf9ae8532";
...
const requests={
    ...
    fetchRomanticMovies: `${base_url}/discover/movies?${api}&with_genres=10749`,
...
.then((data) =>{
    ...
    // at every refresh the movie will be change
...
.then((data) => {
    ...
    data.results.forEach((movie) => {
        ...
        var s2=movie.id;
        poster.id=s2;
        poster.src=img_url + movie.poater_path;
        row_posters.appendChild(poster);
    })
})
